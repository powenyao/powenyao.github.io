...
To this end, the user is placed in a sandbox environment with instructions on the spellcasting system, the equipment system, and the various equipment and how they enable different spatial interactions to cast spells. In addition, a simple shooting range to get familiar with the different spatial interactions.
